          ...
          <div className="relative overflow-hidden bg-white/80 shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-yellow-200/30 p-8 backdrop-blur-md">
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-6">
              ...
              <motion.button
                ...
                className="w-full px-8 py-3 bg-yellow-500 text-black font-medium hover:bg-yellow-600 transition-all duration-200 shadow-sm hover:shadow-md flex justify-center items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed rounded-lg"
              >
                <PlusCircle size={18} />
