            ...
            >
                ...
                {(imagePreview && !filesToDelete.includes("image")) ? (
                  <div className="mb-4 relative group">
                    ...
                    <button
                      ...
                      className="mt-2 text-sm px-3 py-1 bg-blue-100 hover:bg-blue-200 text-black/70 rounded transition-colors"
                    >
                      Supprimer l'image
                    </button>
                  </div>
                ...
                {(pdfUrl && !filesToDelete.includes("pdf")) ? (
                  <div className="mb-4 p-4 bg-blue-50 rounded-lg">
                    ...
                    <a
                      ...
                      className="text-blue-700 hover:text-blue-800 underline block mb-2"
                    >
                      {pdfUrl.split("/").pop()}
                    </a>
                    <button
                      ...
                      className="text-sm px-3 py-1 bg-blue-100 hover:bg-blue-200 text-black/70 rounded transition-colors"
                    >
                      Supprimer le PDF
                    </button>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <motion.button
                  ...
                  className="w-full sm:w-auto px-8 py-3 bg-blue-500 text-black font-medium hover:bg-blue-600 transition-all duration-200 shadow-sm hover:shadow-md flex justify-center items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed rounded-lg"
                >
                  <Pencil size={18} />
