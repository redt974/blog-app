        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-black-700">
              ...
              <a href="mailto:support@example.com" className="text-yellow-600 hover:text-yellow-700 font-medium">
                support@example.com
              </a>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-black-700">
              Consultez notre{' '}
              <a href="/faq" className="text-yellow-600 hover:text-yellow-700 font-medium">
                FAQ
              </a>
